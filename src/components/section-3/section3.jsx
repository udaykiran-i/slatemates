...
import pic9 from "../../images/img-8.jpg";
                ...
                <Grid container columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                    ...
                    <Grid item xs={6}> 
                        <div class="alignment-prop2">
                            ...
                            <h1 class="heading-subtitle2">Teach however you like with integrated video calling, for <br/> 1-on-1 sessions or larger-sized group classes.</h1>
                        </div>
                    </Grid>
                </Grid>
                <Grid container columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
